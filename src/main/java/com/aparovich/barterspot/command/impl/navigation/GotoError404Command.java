...
/**
 * Class provides navigation to 404 error page.
 *
 * @author Maxim Aparovich
 * @see Command
 */
public class GotoError404Command implements Command {

    /**
     * Sets {@link PageNavigator} and {@link HttpServletRequest} properties in order to provide
     * correct navigation to 404 error page.
     *
    ...
    public PageNavigator execute(HttpServletRequest request) {
        return new PageNavigator(PagesManager.getProperty(PAGE_ERROR_404), ResponseType.FORWARD);
    }
}
