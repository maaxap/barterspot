...
/**
 * Provides navigation to static page <i>About Us</i>.
 *
...
public class GotoAboutUsCommand implements Command {
     ...
     * correct navigation to <i>About Us</i> page.
     *
    ...
    public PageNavigator execute(HttpServletRequest request) {
        return new PageNavigator(PagesManager.getProperty(PAGE_ABOUT_US), ResponseType.FORWARD);
    }
}
