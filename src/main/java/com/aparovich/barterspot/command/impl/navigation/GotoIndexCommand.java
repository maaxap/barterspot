...
/**
 * Class provides navigation to page "Index".
 *
...
public class GotoIndexCommand implements Command {
     ...
     * correct navigation to "Index" page.
     *
    ...
    public PageNavigator execute(HttpServletRequest request) {
        return new PageNavigator(PagesManager.getProperty(PAGE_INDEX), ResponseType.FORWARD);
    }
}
