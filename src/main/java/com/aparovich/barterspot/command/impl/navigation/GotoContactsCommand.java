...
/**
 * Class provides navigation to static page "Contacts".
 *
...
public class GotoContactsCommand implements Command {
     ...
     * correct navigation to "Contacts" page.
     *
    ...
    public PageNavigator execute(HttpServletRequest request) {
        return new PageNavigator(PagesManager.getProperty(PAGE_CONTACTS), ResponseType.FORWARD);
    }
}
