...
/**
 * Class provides navigation to page <i>Registration</i>.
 *
...
public class GotoRegistrationCommand implements Command {
     ...
     * correct navigation to registration page.
     *
    ...
    public PageNavigator execute(HttpServletRequest request) {
        return new PageNavigator(PagesManager.getProperty(PAGE_REGISTRATION), ResponseType.FORWARD);
    }
}
