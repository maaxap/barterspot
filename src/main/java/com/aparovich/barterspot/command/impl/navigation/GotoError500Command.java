...
/**
 * Class provides navigation to 500 error page.
 *
...
public class GotoError500Command implements Command {
     ...
     * correct navigation to 500 error page.
     *
    ...
    public PageNavigator execute(HttpServletRequest request) {
        return new PageNavigator(PagesManager.getProperty(PAGE_ERROR_500), ResponseType.FORWARD);
    }
}
