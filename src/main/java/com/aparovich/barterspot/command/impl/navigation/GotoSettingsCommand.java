...
/**
 * Class provides navigation to page <i>Settings</i>.
 *
...
public class GotoSettingsCommand implements Command {
     ...
     * correct navigation to settings page.
     *
    ...
    public PageNavigator execute(HttpServletRequest request) {
        return new PageNavigator(PagesManager.getProperty(PAGE_SETTINGS), ResponseType.FORWARD);
    }
}
