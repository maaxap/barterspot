...
/**
 * Class provides navigation to 403 error page.
 *
 * @author Maxim Aparovich
 * @see Command
 */
public class GotoError403Command implements Command{

    /**
     * Sets {@link PageNavigator} and {@link HttpServletRequest} properties in order to provide
     * correct navigation to 403 error page.
     *
    ...
    public PageNavigator execute(HttpServletRequest request) {
        return new PageNavigator(PagesManager.getProperty(PAGE_ERROR_403), ResponseType.FORWARD);
    }
}
