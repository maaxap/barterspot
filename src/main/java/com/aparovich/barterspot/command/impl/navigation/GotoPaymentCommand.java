...
/**
 * Class provides navigation to page <i>Payment</i>.
 *
...
public class GotoPaymentCommand implements Command {
     ...
     * correct navigation to payment page.
     *
    ...
    public PageNavigator execute(HttpServletRequest request) {
        return new PageNavigator(PagesManager.getProperty(PAGE_PAYMENT), ResponseType.FORWARD);
    }
}
